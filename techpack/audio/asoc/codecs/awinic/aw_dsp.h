...
//#define AW_TX_DEFAULT_TOPO_ID		(0x1001)
//#define AW_RX_DEFAULT_TOPO_ID		(0x1000)

//#define AW_RX_DEFAULT_TOPO_ID		(0x10010260)
//#define AW_RX_DEFAULT_TOPO_ID		(0x1000ff11)
//#define AW_TX_DEFAULT_TOPO_ID		(0x1001ff10)


#define AW_RX_DEFAULT_TOPO_ID		(0x1000ff11)
#define AW_TX_DEFAULT_TOPO_ID		(0x1000ff10)



//PLICE
//#define AW_TX_DEFAULT_PORT_ID		(0x1007)
#define AW_TX_DEFAULT_PORT_ID		(0x1001)

//PLICE
//#define AW_RX_DEFAULT_PORT_ID		(0x1006)

#define AW_RX_DEFAULT_PORT_ID		(0x1000)
