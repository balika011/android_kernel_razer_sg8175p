...
void aw_device_parse_topo_id_dt(struct aw_device *aw_dev)
{
	...
	//aw_dev_info(aw_dev->dev, "tx-topo-id: 0x%x, rx-topo-id: 0x%x",g_tx_topo_id, g_rx_topo_id);
}
...
void aw_device_parse_port_id_dt(struct aw_device *aw_dev)
{
	...
	//aw_dev_info(aw_dev->dev, "tx-port-id: 0x%x, rx-port-id: 0x%x",g_tx_port_id, g_rx_port_id);
