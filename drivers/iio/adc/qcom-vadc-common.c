...
static const struct vadc_map_pt adcsdn_100k[] = {
	{ 2197860 , -30000 },
	{ 2056610 , -29000 },
	{ 1925280 , -28000 },
	{ 1803140 , -27000 },
...
static int qcom_vadc7_scale_hw_calib_therm(
				...
				u16 adc_code, int *result_mdec);
#ifdef CONFIG_MACH_RAZER_NICOLE
static int qcom_vadc7_scale_hw_calib_therm_temp(
				const struct vadc_prescale_ratio *prescale,
				const struct adc5_data *data,
				u16 adc_code, int *result_mdec);
#endif
...
#ifdef CONFIG_MACH_RAZER_NICOLE
	[SCALE_HW_CALIB_THERM_100K_PU_PM7_TEMP] = {
					qcom_vadc7_scale_hw_calib_therm_temp},
#endif
				...
				u16 adc_code, int *result_mdec)
{
	...
	ret = qcom_vadc_map_voltage_temp(adcsdn_100k,
				 ARRAY_SIZE(adcsdn_100k),
				 resistance, &result);
	if (ret)
		return ret;
